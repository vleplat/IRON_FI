...
It also reports the associated bias--variance decomposition:
...
as a function of alpha. This curve is compared with the exact discrete-Lyapunov stationary MSE and with the asymptotic constant
